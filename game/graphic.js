function init()
{
    ...
    player2 = new Player("player2", 0xfffff0, new THREE.Vector2(40, 0), 0);
...
function Ground(color, size_x, size_y, nb_tile)
{
    ...
    tmpfirstGround = new THREE.Mesh(
        ...
        tmpfirstGround.position.x = size_x  / nb_tile;
        tmpfirstGround.position.y = 0;
        scene.add(tmpfirstGround);
